...
q_file = sys.argv[1]
a_file = sys.argv[2]
q_speaker = sys.argv[3]
a_speaker = sys.argv[4]
speaker = sys.argv[5]
top = int(sys.argv[6])
q_para_file = sys.argv[7]
a_para_file = sys.argv[8]
...
with open(a_speaker) as f:
	a_speaker_lines = f.readlines()
f.close()

with open(q_para_file) as f:
	q_para_lines = f.readlines()
f.close()

with open(a_para_file) as f:

...
def sick_score(encoder,bestlrmodel,sen1,sen2):
#    print 'Computing sentence embedding by encoder: '
    testA = encoder.encode(sen1, verbose=False, use_eos=True)
    testB = encoder.encode(sen2, verbose=False, use_eos=True)
...
#    print 'Evaluating...'
    ...
    # print 'Test Spearman: ' + str(sr)
    # print 'Test MSE: ' + str(se)
#    print 'score: '+str(yhat)
    return yhat

def sick_score_batch(encoder,bestlrmodel,sen1_l,sen2_l):
    # print 'Computing sentence embedding by encoder: '
    testA = encoder.encode(sen1_l, verbose=False, use_eos=True)
    testB = encoder.encode(sen2_l, verbose=False, use_eos=True)

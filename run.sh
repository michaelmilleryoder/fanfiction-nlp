...
COLLECTION_NAME="annotated_10fandom_dev"
FICS_INPUT_PATH="/data/fanfiction_ao3/annotated_10fandom/dev/fics"
OUTPUT_PATH="/data/fanfiction_ao3/annotated_10fandom/dev/pipeline_output/"

# If doing quote attribution
BOOKNLP_PATH="/projects/book-nlp"
SVMRANK_PATH="/usr0/home/mamille2/svm_rank"
#TOKENS_PATH="/data/fanfiction_ao3/annotated_10fandom/dev/tokens"

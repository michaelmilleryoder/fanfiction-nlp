...
//    }
    ...
    System.out.println(c1 + "=" + c1.clusterID);
    ...
    System.out.println(c2 + "=" + c2.clusterID);
...
//    } else
    ...
    } else if ((m1.gender.equals(Dictionaries.Gender.FEMALE) && m2.gender.equals(Dictionaries.Gender.MALE))
        && (m2.gender.equals(Dictionaries.Gender.FEMALE) && m1.gender.equals(Dictionaries.Gender.MALE))) {
      System.out.println("wrong merging based on gender!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
      System.out.println(m1 + " with gender " + m1.gender);
      System.out.println(m2 + " with gender " + m2.gender);
    } else {
